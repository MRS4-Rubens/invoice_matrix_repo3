...
export const reactivateCustomer = createAuthenticatedAction(reactivateSchema, async (input, context) => {
  ...
  try {
    ...
    throw new ActionError('We could not reactivate the customer. Please try again.', { code: 'TRANSACTION_FAILED' });
  }
