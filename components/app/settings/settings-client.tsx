...
// ── Page ──────────────────────────────────────────────────────────────────────
export function SettingsClient({ business, currentFy }: { business: any, currentFy: any }) {
  const [initialSettings] = useState(loadInvoiceSettings)
  const [active, setActive] = useState<NavItem>(business ? 'Invoice Settings' : 'Business Profile')
      ...
      <div className="flex gap-6">
        ...
        <div className="flex-1 min-w-0">
          ...
          {active === 'Business Profile' && (
            <BusinessProfileForm business={business} currentFy={currentFy} />
          )}
          ...
          {active !== 'Invoice Settings' && active !== 'General' && active !== 'Business Profile' && (
