...
export default function LoginPage() {
  ...
  return (
    <div className="flex min-h-screen">
      {/* Left panel */}
      <div className="hidden w-2/5 flex-col justify-between bg-primary p-10 md:flex">
        <div>
          {/* Logo */}
          <div className="flex items-center gap-3">
            ...
            <span className="text-base font-semibold text-white">Bill Matrix</span>
          </div>
          ...
          <div className="mt-16 flex flex-col gap-4">
            {[
              'GST-compliant invoices — CGST, SGST, IGST auto-split',
              'Excel ITR export in one click',
              'Secure cloud storage — 6+ year data retention',
            ].map((feat) => (
              <div key={feat} className="flex items-start gap-3">
                <CheckCircle2 className="mt-0.5 size-4 shrink-0 text-success-foreground/80" style={{ color: '#34d399' }} />
